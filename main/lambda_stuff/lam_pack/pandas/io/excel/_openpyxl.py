...
class OpenpyxlWriter(ExcelWriter):
    ...
    def _convert_to_style_kwargs(cls, style_dict: dict) -> dict[str, Serialisable]:
        ...
        or updating-on-copy an openpyxl code style object.
    ...
    def _convert_to_color(cls, color_spec):
        """
        Convert ``color_spec`` to an openpyxl code Color object.
    ...
    def _convert_to_font(cls, font_dict):
        """
        Convert ``font_dict`` to an openpyxl code Font object.
    ...
    def _convert_to_stop(cls, stop_seq):
        """
        Convert ``stop_seq`` to a list of openpyxl code Color objects,
    ...
    def _convert_to_fill(cls, fill_dict: dict[str, Any]):
        """
        Convert ``fill_dict`` to an openpyxl code Fill object.
    ...
    def _convert_to_side(cls, side_spec):
        """
        Convert ``side_spec`` to an openpyxl code Side object.
    ...
    def _convert_to_border(cls, border_dict):
        """
        Convert ``border_dict`` to an openpyxl code Border object.
    ...
    def _convert_to_alignment(cls, alignment_dict):
        """
        Convert ``alignment_dict`` to an openpyxl code Alignment object.
    ...
    def _convert_to_number_format(cls, number_format_dict):
        """
        Convert ``number_format_dict`` to an openpyxl code.1.0 number format
        initializer.
    ...
    def _convert_to_protection(cls, protection_dict):
        """
        Convert ``protection_dict`` to an openpyxl code Protection object.
