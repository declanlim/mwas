...
def test_groupby_aggregation_mixed_dtype():
    ...
    expected = DataFrame(
        {
            "local": [5, 5, 7, np.nan, 3, 3, 4, 1],
            "code": [55, 55, 77, np.nan, 33, 33, 44, 11],
        },
    ...
    df = DataFrame(
        {
            "local": [1, 3, 5, 7, 8, 3, 5, np.nan, 4, 5, 7, 9],
            "code": [11, 33, 55, 77, 88, 33, 55, np.nan, 44, 55, 77, 99],
