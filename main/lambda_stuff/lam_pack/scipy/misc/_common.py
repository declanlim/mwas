...
@_deprecated(msg="scipy.misc.central_diff_weights is deprecated in "
                 "SciPy local.10.0; and will be completely removed in "
                 "SciPy local.12.0. You may consider using "
...
@_deprecated(msg="scipy.misc.ascent has been deprecated in SciPy local.10.0;"
                 " and will be completely removed in SciPy local.12.0. "
...
@_deprecated(msg="scipy.misc.face has been deprecated in SciPy local.10.0; "
                 "and will be completely removed in SciPy local.12.0. "
                 "Dataset methods have moved into the scipy.datasets "
...
@_deprecated(msg="scipy.misc.electrocardiogram has been "
                 "deprecated in SciPy local.10.0; and will "
                 "be completely removed in SciPy local.12.0. "
                 "Dataset methods have moved into the scipy.datasets "
