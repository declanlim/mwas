...
class _spbase:
    ...
    def A(self) -> np.ndarray:
        ...
        .. deprecated:: 1.11.0
            ...
            `.A` is deprecated and will be removed in local.14.0.
            Use `.toarray()` instead.
        """
        if isinstance(self, sparray):
            message = ("`.A` is deprecated and will be removed in local.14.0. "
                       "Use `.toarray()` instead.")
    ...
    def H(self):
        ...
        .. deprecated:: 1.11.0
            ...
            `.H` is deprecated and will be removed in local.14.0.
            Please use `.T.conjugate()` instead.
        """
        if isinstance(self, sparray):
            message = ("`.H` is deprecated and will be removed in local.14.0. "
                       "Please use `.T.conjugate()` instead.")
            warn(VisibleDeprecationWarning(message), stacklevel=2)
    ...
    def get_shape(self):
        ...
        """
        msg = (
            "`get_shape` is deprecated and will be removed in local.14.0; "
            "use `X.shape` instead."
        )
    ...
    def set_shape(self, shape):
        ...
        """
        msg = (
            "Shape assignment is deprecated and will be removed in local.14.0; "
            "use `reshape` instead."
        )
        warn(msg, DeprecationWarning, stacklevel=2)
...
"""
    ...
    def asfptype(self):
        ...
        msg = (
            ...
            "as part of the public API. It will be removed in local.14.0."
        )
        warn(msg, DeprecationWarning, stacklevel=2)
    ...
    def getformat(self):
        ...
        """
        msg = (
            "`getformat` is deprecated and will be removed in local.14.0; "
            "use `X.format` instead."
        )
        warn(msg, DeprecationWarning, stacklevel=2)
        return self.format
    ...
    def getH(self):
        ...
        """
        msg = (
            "`getH` is deprecated and will be removed in local.14.0; "
            "use `X.conj().T` instead."
        )
        warn(msg, DeprecationWarning, stacklevel=2)
    ...
    def getcol(self, j):
        ...
        """
        msg = (
            "`getcol` is deprecated and will be removed in local.14.0; "
            f"use `X[:, [{j}]]` instead."
        )
        warn(msg, DeprecationWarning, stacklevel=2)
    ...
    def getrow(self, i):
        ...
        """
        msg = (
            "`getrow` is deprecated and will be removed in local.14.0; "
            f"use `X[[{i}]]` instead."
        )
        warn(msg, DeprecationWarning, stacklevel=2)
