...
class TestDataFrameReplace:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # list of [re1, re2, ..., reN] -> [local, code, ..., vN]
            (
                [r"\s*\.\s*", r"e|f|g"],
                [np.nan, "crap"],
                {
            ...
            # list of [re1, re2, ..., reN] -> [(re1 or local), (re2 or code), ..., (reN
            # or vN)]
            (
                [r"\s*(\.)\s*", r"e"],
                [r"\1\1", r"crap"],
    ...
    def test_regex_replace_dict_mixed(self, mix_abc):
        ...
        # dicts
        # single dict {re1: local}, search the whole frame
        # need test for this...

        # list of dicts {re1: local, re2: code, ..., re3: v3}, search the whole
        # frame
    ...
    def test_replace_list(self):
        ...
        # lists of regexes and values
        # list of [local, code, ..., vN] -> [local, code, ..., vN]
